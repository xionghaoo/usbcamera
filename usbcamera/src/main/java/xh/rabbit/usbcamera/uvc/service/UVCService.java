...
//		Intent intent = new Intent(this, Class.forName("xh"));
...
//			.setContentIntent(pendingIntent)  // The intent to send when the entry is clicked
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			...
			String name = "uvc_camera";
			String description = "uvc_camera";
			NotificationChannel channel = new NotificationChannel("uvc_camera_channel", name, NotificationManager.IMPORTANCE_DEFAULT);
