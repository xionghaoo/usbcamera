...
//        val list = mUSBMonitor!!.deviceList
        ...
        list.forEach { device ->
            if (device.productId == pid) {
                ...
                if (mCameraClient == null) mCameraClient = CameraClient(activity, points, packageName, mCameraListener)
                // 确认USB权限，注册回调方法
    ...
    companion object {
        ...
        fun newInstance(pid: Int, points: ArrayList<PointF>, packageName: String) = UvcFragment().apply {
